...
function onHashChange() {
  ...
  try {
    ...
    if (onMobile && (hash.slice(1) != '')) {
      console.log('aqui1')
      $('.profile-sidenav').hide();
      $('.arrow-container').removeClass('hide');
      $(".profile-forms-container").removeClass('hide-on-small-only');
    ...
    } else if (onMobile && (hash.slice(1) == '')) {
      console.log('aqui2')
      $('.profile-sidenav').show();
      $(".profile-forms-container").addClass('hide-on-small-only');
